...
*    
*      Changed to use Randall style greensfunction names,
*      HPCrotwell, Oct 26 1995
*
      program marktime
*
      integer mxl, mxpts
      parameter (mxl = 350, mxpts = 4096)
      real alpha(mxl), beta(mxl)
      real rho(mxl), th(mxl), xdummy, seis(mxpts)
      real src_depth, range, user(3)
      real t, dh, tmin
      character*256 modelfile, gftn_name, infile, tempinfile
      character*4 suf(6)
      character*2 pre(3)
*
...
*
         write(stdout,*)'e.g. usage: mmarktime modelfilename 1000_0010'
         write(stdout,*)'where distance = 1000 and depth = 0010'
         stop
*
       end if
*
...
*        responses
*
       tempinfile(1:nlen+2) = pre(1)(1:2)//gftn_name(1:nlen)
       infile(1:nlen+6) = tempinfile(1:nlen+2)//suf(1)(1:4)
       write(stdout,*)'infile: ',infile(1:nlen+6)
       call newhdr   
...
*   
      ...
      if(tmin .lt. 1e6)then
         do 201 j = 1, 3
         do 200 i = 1, 6
           tempinfile(1:nlen+2) = pre(j)(1:2)//gftn_name(1:nlen)
           infile(1:nlen+6) = tempinfile(1:nlen+2)//suf(i)(1:4)
*           call newhdr   
...
*     
      ...
      integer stdin,stdout, stderr
      real dh,t,ray_p,ray_p2,dummy,dh
      integer im1,ip1,j
